const twMap:any = {
	...
	"margin-top": {
		...
		"-16rem": ".-mt-64",
		"-1px": ".-mt-px",
		"0.2rem": ".mt-3.16668701171875",
		"-1.31rem": ".mt--20.90008544921875",
		"-0.03rem": ".mt--0.5"
	},
	"margin-right": {
		"0": ".mr-0",
	...
	"margin-bottom": {
		...
		"-1px": ".-mb-px",
		"0.31rem": ".mb-5",
		"0.2rem": ".mb-3.166646957397461",
		"-0.99rem": ".mb--15.833250045776367",
		"-0.03rem": ".mb--0.5"
	},
	"margin-left": {
		"0": ".ml-0",
	...
	"width": {
		...
		"10.69rem": ".w-171",
		"2.38rem": ".w-38",
		"1.98rem": ".w-31.66666603088379",
		"2.85rem": ".w-45.599998474121094",
		"7.69rem": ".w-123",
		"4.31rem": ".w-69",
		"0.38rem": ".w-6",
		"4.88rem": ".w-78",
	...
	"height": {
		...
		"14.81rem": ".h-237",
		"2.38rem": ".h-38",
		"1.98rem": ".h-31.66666603088379",
		"4.28rem": ".h-68.4000015258789",
		"1.44rem": ".h-23",
		"0.94rem": ".h-15",
		"11.44rem": ".h-183",
		"3.63rem": ".h-58",
	...
	"font-family": {
		"system-ui,-apple-system,BlinkMacSystemFont,\"SegoeUI\",Roboto,\"HelveticaNeue\",Arial,\"NotoSans\",sans-serif,\"AppleColorEmoji\",\"SegoeUIEmoji\",\"SegoeUISymbol\",\"NotoColorEmoji\"": ".font-sans",
		"Georgia,Cambria,\"TimesNewRoman\",Times,serif": ".font-serif",
		"Menlo,Monaco,Consolas,\"LiberationMono\",\"CourierNew\",monospace": ".font-mono"
	},
	"font-size": {
		".75rem": ".text-xs",
		".875rem": ".text-sm",
	...
	"letter-spacing": {
		...
		"0.03rem": ".tracking-0.5",
		"-0.16rem": ".tracking-neg-2.5"
	},
	"line-height": {
		"1": ".leading-none",
		"2": ".leading-loose",
	...
	"transition-property": {
		...
		"all": ".transition-all",
		"background-color,border-color,color,fill,stroke,opacity,box-shadow,transform": ".transition",
